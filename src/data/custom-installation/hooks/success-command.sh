...
#https://bugs.launchpad.net/ylmfos-livecd /+source/ubiquity/+bug/150930
...
#rm /host/ylmfos-livecd /install/custom-installation/preseed.cfg || true
#rm /host/ylmfos-livecd /install/boot/grub/menu.lst || true
rm -rf /host/ylmfos-livecd /install || true
