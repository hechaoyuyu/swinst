...
import logging
log = logging.getLogger("WinuiFixFinishPage")

class FixFinishPage(Page):
    ...
    def on_init(self):
        ...
        self.main.title = ui.Label(self.main, 40, 20, self.main.width - 80, 60, _("Fix completed"))
        self.main.title.set_font(size=20, bold=True, family="Arial")
        self.main.label = ui.Label(self.main, 40, 90, self.main.width - 80, 40, _("%s Fixer fixing completed") % self.info.distro.name)
